...
CLM.L["Award item"] = "Attribuez l'objet"
...
CLM.L["level"] = "niveau"
CLM.L["Link Alt to Main"] = "Lier Alt au Main"
...
CLM.L["Loot Queue"] = "File d'attente de butin"
...
CLM.L["Mark as alt"] = "Marquer comme alt"
CLM.L["Marks selected profiles or everyone if none selected as alts of choosen player (from dropdown)."] = "Marque les profils sélectionnés ou tout le monde si aucun n'est sélectionné comme alts du joueur choisi (dans la liste déroulante)."
CLM.L["Max: %d "] = "Маx: %d "
CLM.L["Max"] = "Маx"
...
CLM.L["Notify that you are passing on the item. Cancels any existing bids."] = "Avertissez que vous transmettez l'article. Annule toutes les offres existantes."
CLM.L["Num"] = "Nombre"
...
CLM.L["Select character to be marked as main for alt-main linking."] = "Sélectionnez le caractère à marquer comme principal pour le lien alt-main."
...
CLM.L["Unlink Alt"] = "Dissocier Alt"
